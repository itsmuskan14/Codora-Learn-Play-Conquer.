    ...
    <footer className="bg-card/50 border-t border-border">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Empowering the next generation of developers through gamified, AI-powered learning experiences.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Individual Skills</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Job Placement</a></li>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; 2024 Codora. All rights reserved. Built for learners, by learners.</p>
        </div>
      </div>
    </footer>
  );
